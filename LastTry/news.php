      ...
      <div class="loader"></div>
        ...
        <section class="active-menu" id="menu">
            ...
            <div class="menu-list">
              ...
              <a href="gallery.php" class="munu-list__item">Галерея работ</a>
              <a href="#" class="munu-list__item">Мой блог</a>
          ...
          <?php
            ...
            while($article = mysqli_fetch_assoc($query)) {
              ...
              '<div class="news-main-article">
                ...
                <a href="news-single-page.php?id='.$article['id'].'" class="button">Далее</a>
              </div>';
            }
          ?>
              </div>
          ...
          <footer class="home-footer">
            ...
            <p>Есть проект, который вы хотели бы обсудить?</p>
                  <a href="#" class="footer-block__button">Напишите мне</a>
                </div>
                <div class="footer-block__item">
